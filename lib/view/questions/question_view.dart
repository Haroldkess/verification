...
class QuestionView extends StatelessWidget {
  final String? q;
  const QuestionView({super.key, this.q});
      ...
      children: [
        ObxValue((questions) {
          final thisQuestions = questions
              .where((element) =>
                  element.category.toString().toLowerCase() == q!.toLowerCase())
              .toList();
          ...
          return ExpansionTileCard(
              ...
              children: List.generate(
                  ...
                  (index) => Padding(
                      ...
                      child: thisQuestions[index].fieldtype.toString() == "Y/N"
                          ? YesOrNo(
                          ...
                          : QuestionForm(
                              isDate:
                                  thisQuestions[index].fieldtype.toString() ==
                                          "Date"
                                      ? true
                                      : false,
                              id: thisQuestions[index].id!,
